...
const [timer, setTimer] = useState(0);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`https://smart-healthcare-app-ghwj.onrender.com/api/${role}/login`, {
        method: "POST",
...
if (data.role === "pharmacy") {
  ...
  const res = await fetch("https://smart-healthcare-app-ghwj.onrender.com/send-reset-otp", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
const handleVerifyResetOtp = async () => {
  ...
  const res = await fetch("https://smart-healthcare-app-ghwj.onrender.com/verify-reset-otp", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
const handleResetPassword = async () => {
  const res = await fetch("https://smart-healthcare-app-ghwj.onrender.com/reset-password", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({
      email: resetEmail,
